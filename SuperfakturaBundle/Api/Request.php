...
use Application\SuperfakturaBundle\Api\Requests\Requests_Auth;
use Application\SuperfakturaBundle\Api\Requests\Requests_Exception;
use Application\SuperfakturaBundle\Api\Requests\Requests_Hooks;
use Application\SuperfakturaBundle\Api\Requests\Requests_IDNAEncoder;
use Application\SuperfakturaBundle\Api\Requests\Requests_IPv6;
use Application\SuperfakturaBundle\Api\Requests\Requests_IRI;
use Application\SuperfakturaBundle\Api\Requests\Requests_Response;
use Application\SuperfakturaBundle\Api\Requests\Requests_Transport;
use Application\SuperfakturaBundle\Api\Requests\Auth\Requests_Auth_Basic;
use Application\SuperfakturaBundle\Api\Requests\Response\Requests_Response_Headers;
use Application\SuperfakturaBundle\Api\Requests\Transport\Requests_Transport_cURL;
use Application\SuperfakturaBundle\Api\Requests\Transport\Requests_Transport_fsockopen;
...
class Request {
	...
	protected static function get_transport() {
		...
		if (function_exists('curl_init') && function_exists('curl_exec')) {
            self::$transport = 'Requests_Transport_cURL';
        }
        else if (function_exists('fsockopen')) {
            self::$transport = 'Requests_Transport_fsockopen';
        }
	...
	protected static function parse_response($headers, $url, $req_headers, $req_data, $options) {
		...
		$headers = explode("\n", $headers);
        preg_match('#^HTTP/[012.]+[ \t]+(\d+)#i', array_shift($headers), $matches);
		if (empty($matches)) {
