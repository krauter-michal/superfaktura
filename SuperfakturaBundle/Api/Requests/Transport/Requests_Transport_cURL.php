...
namespace Application\SuperfakturaBundle\Api\Requests\Transport;
...
class Requests_Transport_cURL implements Requests_Transport {
	...
	public function request($url, $headers = array(), $data = array(), $options = array()) {
		...
		$headers = Request::flattern($headers);
		if (($options['type'] === Request::HEAD || $options['type'] === Request::GET) & !empty($data)) {
